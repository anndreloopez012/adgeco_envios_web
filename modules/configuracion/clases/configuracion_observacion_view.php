...
class configuracion_observacion_view{
    ...
    public function drawContent() {
        ...
        $objTemplate->draw_modal_draw_header("Cambio de observacion predeterminado","",true,"");
        $objTemplate->draw_modal_open_content("divAlertaCambioPredeterminado");
        ?>
        <div class="text-center">Ya hay un observacion predeterminado, solo puedo haber un observacion predeterminado</div>
        ...
        <script>
            ...
            function fntOpen(intId) {
                ...
                if( intId == 0 ){
                    ...
                    $.ajax({
                         ...
                         type: "post",
                         dataType: "json",
                         data: "metodo=checkEliminar&observacion="+intId,
                         success: function( data ){
                             if( data.estado == "fail" ) {
                                 $("#btnEliminar").hide();
                             }
                ...
                $.ajax({
                     ...
                     type: "post",
                     dataType: "html",
                     data: "metodo=drawContentModal&observacion="+intId+"&edicion="+edicion,
                     success: function( data ){
                         hideImgCoreLoading();
            ...
            function fntEliminar() {
                (new PNotify({
                    title: 'Confirmar',
                    text: '¿Esta seguro de eliminar el observacion?',
                ...
                <tr>
                    ...
                    <td style="text-align: center;">
                        ...
                        if($arrI["value"]["predeterminado"] == "Y"){
                            ?><input id="hdnPredeterminado_<?php print $arrI["value"]["observacion"]; ?>" type="text" value="<?php print $arrI["value"]["predeterminado"];?>" class="ocultar" />
                        <?php
                        }
                        ?>
                    </td>
    ...
    public function drawContentModal(){
        ...
        $intId = isset($_POST["observacion"]) ? intval($_POST["observacion"]) : 0;
        if( $intId > 0 )
        ...
        $objForm->add_input_hidden("observacion",$intId,true);
        ?>
        <div class="row">
            <?php
